...
const minifyModule = (packageName, options) => __awaiter(void 0, void 0, void 0, function* () {
    return new Promise((resolve, reject) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            const mod = yield (0, utils_1.getPackage)(packageName, tmpDir, { version: options.version, verbose: options.verbose });
            if (!mod)
            ...
            else if (!(0, path_1.isAbsolute)(options.minifiedDestination))
            ...
            yield (0, utils_1.uninstallPackage)(packageName, { version: options.version, verbose: options.verbose });
