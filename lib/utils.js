...
const installPackageInTemp = (packageName, tempDir, packageOptions) => __awaiter(void 0, void 0, void 0, function* () {
    yield execNpmCommand('install', [packageName], packageOptions, { cwd: tempDir });
});
...
const getPackage = (packageName, tmpDir, packageOptions) => __awaiter(void 0, void 0, void 0, function* () {
    let packagePath;
    try {
        yield (0, exports.installPackageInTemp)(packageName, tmpDir, packageOptions);
...
const uninstallPackage = (packageName, packageOptions) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        return yield execNpmCommand("uninstall", [packageName], packageOptions);
    }
    catch (error) {
...
const execNpmCommand = (command, args, packageOptions, spawnOptions) => __awaiter(void 0, void 0, void 0, function* () {
    // Validate arguments
    ...
    if (packageOptions === null || packageOptions === void 0 ? void 0 : packageOptions.version)
